...
/**
 * @file
 * Contains \Drupal\site_common\Plugin\Condition\TaxonomyVocabulary.
 */
namespace Drupal\site_common\Plugin\Condition;
...
class TaxonomyVocabulary extends ConditionPluginBase implements ContainerFactoryPluginInterface
{
  ...
  public function summary() {
    if (count($this->configuration['bundles']) > 1) {
      ...
      return $this->t('The vocabulary is @bundles or @last', array('@bundles' => $bundles, '@last' => $last));
    }
    $bundle = reset($this->configuration['bundles']);
    return $this->t('The vocabulary is @bundle', array('@bundle' => $bundle));
  }
  ...
  public function evaluate() {
    ...
    return !empty($this->configuration['bundles'][$taxonomy_term->getVocabularyId()]);
  }
